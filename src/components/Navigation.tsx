		...
		<nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-lg border-b border-border">
			<div className="container mx-auto px-4 py-4">
				<div className="flex items-center justify-between">
					...
					>
						<div className="w-10 h-10 bg-[hsl(var(--nav-theme))] rounded-lg flex items-center justify-center font-bold text-xl">W</div>
						<span className="font-bold text-lg hidden sm:inline">Wizard Alchemy</span>
						<span className="font-bold text-lg sm:hidden">WA</span>
					</Link>
