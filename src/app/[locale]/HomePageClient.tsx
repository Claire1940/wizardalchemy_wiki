    ...
    "@graph": [
      {
        ...
        description:
          "Complete Wizard Alchemy Wiki covering Roblox codes, potion recipes, races, spells, materials, chest locations, and progression tips.",
        image: {
          "@type": "ImageObject",
          url: `${siteUrl}/images/hero.webp`,
          width: 1920,
          height: 1080,
          caption: "Wizard Alchemy - Roblox Magic Action RPG",
        },
        potentialAction: {
          "@type": "SearchAction",
      ...
      },
      {
        ...
        name: "Wizard Alchemy Wiki",
        alternateName: "Wizard Alchemy",
        url: siteUrl,
        description:
          "Complete Wizard Alchemy Wiki resource hub for codes, potions, races, spells, materials, and progression guides.",
        logo: {
          "@type": "ImageObject",
        ...
        image: {
          ...
          width: 1920,
          height: 1080,
          caption: "Wizard Alchemy Wiki - Roblox Magic Action RPG",
        },
        sameAs: [
      ...
      },
      {
        ...
        genre: ["Action RPG", "Magic", "Adventure"],
        numberOfPlayers: {
          minValue: 1,
          maxValue: 1,
        },
        offers: {
          ...
          url: "https://www.roblox.com/games/118821269826806/Wizard-Alchemy",
        },
      },
      {
        "@type": "VideoObject",
        name: "Wizard Alchemy Gameplay and Guide",
        description:
          "Wizard Alchemy gameplay guide covering codes, races, chest locations, and material routes.",
        uploadDate: "2026-05-12",
        thumbnailUrl: `${siteUrl}/images/hero.webp`,
        embedUrl: "https://www.youtube.com/embed/1WqLnUZm2J0",
        url: "https://www.youtube.com/watch?v=1WqLnUZm2J0",
      },
    ],
  };
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  <a
                    href="https://discord.com/invite/8z84cEsu"
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a
                    href="https://www.youtube.com/watch?v=1WqLnUZm2J0"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground hover:text-[hsl(var(--nav-theme-light))] transition"
                  >
                ...
                <li>
                  <a
                    href="https://www.roblox.com/communities/509055872/Muggle-Academy"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground hover:text-[hsl(var(--nav-theme-light))] transition"
                  >
